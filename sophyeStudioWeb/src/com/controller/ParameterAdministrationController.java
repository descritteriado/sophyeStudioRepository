...
public class ParameterAdministrationController {
	...
	public void consultParameters(String origin) {
		...
		try {
			parameters = securitiesService.getParameters(parameterName, parameterDescription);
			result = true;
	...
	public void mergeParameter(Integer action) {
		...
		confirmacion = securitiesService.mergeParameter(this.parametro);
	...
	public void removeParameter() {
		...
		confirmacion = securitiesService.deleteParameter(this.parametro);

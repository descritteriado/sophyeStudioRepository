...
public class MenuController {
	...
	/**
	 *  M&#233;todo para obtener el menu dado el c&#243;digo
	 * 
	 * @param C&#243;digo de M&#243;dulo
	 * @return List <Object> 
	 */
	...
	/**
	 * M&#233;todo para consultar y armar el menu en base a la parametrización de la base de datos 
	 */
	private void construcMenu() {
		...
		List<Object> trxReportes = this.getMenu(Constants.MODULO_REPORTES);
		...
		if (trxReportes.size() > 0) {
			model = this.addItems(model, trxReportes);
		}
	}

	/**
	 * M&#233;todo para adherir las transacciones a los submenus
	 * @param MenuModel
